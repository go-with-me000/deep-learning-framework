        ...
        <Row type="flex" justify="space-between" class="code-row-bg">
          <Col span="18">
            <Row type="flex" justify="start" class="code-row-bg">
              ...
              <Col span="3.5" style="position:relative;left:15px;right:15px;background:#fff">
                <Select
                  v-model="academyChoose"
              ...
              <Col span="3.5" style="position:relative;left:25px;right:15px;">
              ...
              <Col span="5.5" style="position:relative;left:25px;">
                <Select
                  v-model="state"
    ...
    <Modal title="增加投票项目" v-model="addmodal" width="450" :styles="{top: '80px'}">
      ...
      <div style="width:100%;position:relative">
        <Form ref="projectInfo" :model="projectInfo" :label-width="100">
          ...
          <FormItem label="所属学院">
            <Select v-model="projectInfo.chooseAcademy" style="width:100%" placeholder="请选择项目所属学院">
              <Option v-for="item in academyList" :value="item" :key="item">{{ item }}</Option>
            </Select>
          </FormItem>
          <FormItem label="投票方式">
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      this.loading = true;
      let academyChoose =
        this.academyChoose != "全部" ? this.academyChoose : "";
        ...
        .then(res => {
          if (res.data.code === "SUCCESS") {
            ...
            if (res.data.data != 0) {
              ...
              this.data = res.data.data.adShowList;
    ...
    createNewProject2() {
      ...
      let chooseAcademy = this.projectInfo.chooseAcademy;
      if (method == "线上投票") {
        method = 1;
      } else {
        method = 2;
  ...
  watch: {
    ...
    addmodal(val, oldVal) {
      if (!val) {
        ...
        this.projectInfo.chooseAcademy = "";
