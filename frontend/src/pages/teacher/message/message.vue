      ...
      <Col span="16">
        <div class="content">
          ...
          >
            ...
            <FormItem label="工号">
              <Input v-model="person_info.teacherNum" placeholder="请输入您的工号" disabled></Input>
            </FormItem>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      let URL = `${apiPath}/controlmessage`;
      axios({
        url: URL,
        method: "get",
        params:{
        ...
        .then(res => {
           this.person_info.teacherName = res.data.teacherName;
          this.person_info.teacherNum = res.data.teacherNum;
  ...
  mounted() {
    ...
    this.teacherNum = localStorage.getItem("userId")
    this.loadData();
  },
